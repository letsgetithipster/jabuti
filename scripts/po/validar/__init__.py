...
from po.validar.check_publicacao import checar_publicacao
from po.validar.check_segredos import checar_segredos

CHECKS = [checar_frontmatter, checar_perfil, checar_politica, checar_harness, checar_dados,
          checar_estado, checar_segredos, checar_publicacao]
